...
public class MeetingDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View l = inflater.inflate(R.layout.fragment_meeting_details, container, false);
        Button joinGroup = l.findViewById(R.id.btnJoinMeeting);
        joinGroup.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((MeetingCreatorActivity) getActivity()).joinGroup();
            }
        });

        Button goBack = l.findViewById(R.id.btnReturn);
        goBack.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ((MeetingCreatorActivity) getActivity()).back();
            }
        });
        return l;
    }

    interface MeetingDetailsFragmentInterface {
